...
def Create_Robot():
    ...
    pyrosim.Send_Cube(name="Link5", pos=[0,1.0,-0.5] , size=[1,1,1])
    pyrosim.Send_Joint(name = "Link6_Link5" , parent= "Link5" , child = "Link6" , type = "revolute", position = [0,-0.5,-1.0])
    pyrosim.Send_Cube(name="Link6", pos=[0,1.5,-0.5] , size=[1,1,1])
    pyrosim.End()
